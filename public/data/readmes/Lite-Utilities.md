[![](https://img.shields.io/endpoint?url=https://api.runelite.net/pluginhub/shields/installs/plugin/lite-utilities)](https://runelite.net/plugin-hub/show/lite-utilities)
