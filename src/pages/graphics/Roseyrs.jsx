      ...
      <section className="max-w-6xl mx-auto space-y-10 px-4">
        ...
        <div
          ...
          <div className="max-w-6xl mx-auto flex justify-center">
            <button
              onClick={scrollToTop}
              className="bg-rosey text-dark text-xl font-bold rounded-tl-2xl rounded-tr-2xl px-6 py-3 shadow-lg hover:bg-rosey transition-all duration-300 animate-bounce"
              title="Back to Top">
              ↑ Back to Top
            </button>
          </div>
